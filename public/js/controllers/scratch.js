//begin adding event listeners to the markers
// for (var i = 0; i < theatresArray.length; i++) {
//   marker[i].addListener('click', function(){
//     console.log(i);
//     console.log(theatresArray);
//     console.log(theatresArray[i]);
//       //api call to get showtime data
//       $http.get('https://data.tmsapi.com/v1.1/theatres/'+theatresArray[i].theatreId+'/showings?'+todaysDate+'&api_key=qf6mzc3fkprbntfd95db3hkk')
...
//           $('#dir',i).on('click', function(){
//             window.location.href = "#/map/"+theatresArray[i].theatreId;
//           });
//           $('#'+theatresArray[i].theatreId).on('click', function(){
//             window.location.href = "/#/showtimes/"+theatresArray[i].theatreId
//           });
//           var movieCache = [];
//           $('#moreMove',i).on('click', function(){
...
//            $('.'+theatresArray[i].theatreId).find('li')[0].remove();
//            $('.'+theatresArray[i].theatreId).append(
...
//                 $('.'+theatresArray[i].theatreId).find('li')[4].remove();
//               }
//               $('.'+theatresArray[i].theatreId).prepend(
...
//             for (var k = 0; k < showtimes.data.length; k++) {
//               var time = showtimes.data[k].showtimes[0].dateTime.split('');
//               var filteredTime = time.slice(time.length-5, time.length).join('');
//               //end finding time
//               $('.'+theatresArray[i].theatreId).append(
//                 '<li>'+showtimes.data[k].title+' '+filteredTime+'</li>')
//             }
...
///////end geolocation callback nesting most of this function
}
